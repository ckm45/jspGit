 ...
 */
@WebServlet({"/view/member/join","/view/member/checkId", "/view/member/mail", "/view/member/kakaoLogin", "/view/member/kakaoJoin", "/view/member/login"})
...
public class MemberController extends HttpServlet {
    ...
    protected void doPost(HttpServletRequest request, HttpServletResponse response)
        ...
        String command = uri.substring(conPath.length() + 13);
        ...
        else if (command.equals("kakaoJoin")) {
            MemberService service = new MemberServiceImpl();
