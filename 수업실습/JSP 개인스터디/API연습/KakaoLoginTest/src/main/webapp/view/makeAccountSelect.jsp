	...
	<div class="section1">
		...
		<table id="product-table">
			...
			<tbody>
				<tr>
					<td>입출금상품</td>
					<td><a href="#" onclick="passText(this, '입출금 상품 A')">입출금
							상품 A</a></td>
				</tr>
				<tr>
					<td>입출금상품</td>
					<td><a href="#" onclick="passText(this, '입출금 상품 B')">입출금
							상품 B</a></td>
				</tr>
				<tr>
					<td>예금적금상품</td>
					<td><a href="#" onclick="passText(this, '예금적금 상품 X')">예금적금
							상품 X</a></td>
				</tr>
				<tr>
					<td>예금적금상품</td>
					<td><a href="#" onclick="passText(this, '예금적금 상품 Y')">예금적금
							상품 Y</a></td>
				</tr>
				<tr>
					<td>보험상품</td>
					<td><a href="#" onclick="passText(this, '보험 상품 I')">보험 상품
							I</a></td>
				</tr>
				<tr>
					<td>보험상품</td>
					<td><a href="#" onclick="passText(this, '보험 상품 II')">보험 상품
							II</a></td>
				</tr>
			</tbody>
		</table>
