			...
			<div class="container-fluid">
				...
				<div class="collapse navbar-collapse justify-content-center"
					...
					<ul class="navbar-nav mb-2 mb-lg-0">
						...
						<li class="nav-item"><a class="nav-link" href="#">거래내역조회</a>
						</li>
      ...
      if (message !== 'null' && message !== '') {
         alert(message);
				...
				<div class="form-container">
					<form action="kakaoJoin.member" method="post"
						onsubmit="return validatePersonalId() && validateSimplePw() && validateAddress()">
						<!--  <h2>회원가입</h2> -->
						...
						<input type="hidden" name="kakaoId"
							value="<%= session.getAttribute("kakaoId") %>">
						<!-- 카카오 아이디 가져오기 -->
