...
.form-group input[type="text"], .form-group input[type="password"], .form-group input[type="checwooriox"]
   {
   width: 100%;
   padding: 12px;
...
.form-group input[type="text"]:focus, .form-group input[type="password"]:focus,
   .form-group input[type="checwooriox"]:focus {
   outline: none;
   border-color: #009490;
}
...
.form-group-duplicate input[type="text"]:focus,
.form-group-duplicate .input-group-btn:focus {
    outline: none;
    border-color: #009490;
}
...
.checwooriox-group input[type="checwooriox"] {
   margin-right: 5px;
}
            ...
            <%--    <div class="form-group">
               ...
               <div class="form-group-duplicate">
                   ...
                   <div class="input-group">
                    ...
                    <button type="button" class="input-group-btn" onclick="checkDuplicateId()">중복 확인</button>
                   </div>
               </div>
               ...
               <div class="form-group">
                  ...
                  <button type="button" class="input-group-btn" onclick="sample6_execDaumPostcode()">우편번호 찾기</button>
               ...
               <div class="button-container">
                  <button type="button" onclick="sendMail()">인증 메일 발송</button><br>
               </div>
               ...
               <div class="form-group-duplicate">
                   ...
                   <div class="input-group">
                    ...
                    <button type="button" class="input-group-btn" onclick="checkCode()">코드 확인</button>
                   </div>
               </div>


<div class="button-container">
  <input type="submit" value="회원가입 요청" class="btn btn-primary" style="background-color: #8298A6 !important; color: #ffffff !important; font-size: 15px !important; font-weight: bold !important; border-radius: 30px !important; padding: 12px 80px; cursor: pointer;">
</div>
</form>
